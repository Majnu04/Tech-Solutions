  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-primary-500/5 via-dark-950 to-dark-800" />
      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-dark-200 mb-10 md:mb-12 max-w-4xl mx-auto leading-relaxed font-normal px-4 sm:px-0"
          >
