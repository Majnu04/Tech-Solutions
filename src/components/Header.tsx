        ...
        <div className="section-container py-0 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="hidden md:inline-flex items-center justify-center rounded-full bg-gradient-to-r from-[#7C3AED] to-[#22D3EE] px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-primary-500/25 transition hover:opacity-90"
            >
              Get Instant Estimate
            </button>
            ...
            <button
              onClick={() => setEstimateOpen(true)}
              className="md:hidden inline-flex items-center justify-center rounded-full bg-gradient-to-r from-[#7C3AED] to-[#22D3EE] px-3 py-2 text-xs font-semibold text-white shadow-md shadow-primary-500/20 transition hover:opacity-90"
            >
              Estimate
            </button>
